<?php
    ...
    if($rows_fetched>0){
        ...
        $user_registration_query="insert into users(name,uname,email,password,address,mobile,gender,dob) values ('$name','$uname','$email','$password','$address','$mobile','$gender','$dob')";
        ...
        ?>
        <meta http-equiv="refresh" content="3;url=../View/dashbord.php" />
        <?php
    }
