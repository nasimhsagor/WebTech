...
?>
<a href="../Controller/cart_add.php?id=1" class="btn btn-block btn-primary" name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
<?php
}
}
?>
...
?>
<a href="../Controller/cart_add.php?id=2" name="add" value="add">Add to cart</a>
<?php
}
}
?>
...
?>
<a href="../Controller/cart_add.php?id=3" class="btn btn-block btn-primary" name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
<?php
}
}
?>
